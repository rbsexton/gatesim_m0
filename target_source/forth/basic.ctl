...
\ file: em0.log                \ uncomment to send log to a file
...
\ *P The Flash memory starts at $0000:0000. 
  ...
  $0000:0000 $0000:7FFF cdata section M0	\ code section in boot Flash
  $2000:0000 $2000:01FF idata section PROGd	\  IDATA
  $2000:0200 $2000:0FFF udata section PROGu	\  UDATA
...
$200 equ UP-SIZE		\ size of each task's user area
...
: .CPU		\ -- ; display CPU type
  ." MPE ROM PowerForth for FPGA Cortex-M0" cr
...
include %DriverDir%/FIFO_p \ polling serial driver
